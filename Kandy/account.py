...
class Account:
    ...
    def delete_account_access_token(self, api_key, account_api_secret, account_access_token):
    ...
    def create_domain(self, account_access_token, domain_name, project_name):
